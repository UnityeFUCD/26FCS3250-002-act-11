...
In this activity you will practice class design using a tool called [PlantUML](https://www.plantuml.com). 

# Setup 

You can use PlantUML online or setup [PlantUML's VS Code extension](https://marketplace.visualstudio.com/). An online [PlantUML Guide](https://plantuml.com/guide) is available as well. 
...
## Scenario 1: Employees, Departments, and Dependents
...
## Scenario 2: Sales, Items, and Sellers
...
## Scenario 3: Courses, Sections, Students, and Instructors
